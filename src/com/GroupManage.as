package com 
{
	 ...
	 * @author codex
	 */
	public class GroupManage extends EventDispatcher
	{
		[Event(name = "change", type = "mx.events.IndexChangedEvent")]
		static private var groupSource:Object = new Object();
		static public function getGroupManage(g:String):GroupManage
		{
			return groupSource[g];
		}
		static public function addGroupManage(g:String, gm:GroupManage):void
		{
			groupSource[g] = gm;
		}
		...
		public function GroupManage(g:String = null) 
		{

package controls.frames 
{
	 ...
	 * @author CodeX
	 */
	public class ChooseFrame extends Canvas implements IPlugin
	{
		private var _type:String = "";
		private var cross:Cross_;
		private var btnLayer:Canvas;
		private var length:int;
		private var blankHeight:Number;
		private var fmt:TextFormat;
		private var blankX:Number;
		private var tm:TimeManage;
		private var gm:GroupManage;
		/**@private */
		public function ChooseFrame() 
		{
			...
			tm = new TimeManage();
			tm.addEventListener(TimeManage.MOTION_COMPLETE, tm_complete);
			var dp:ArrayCollection = new ArrayCollection();
			dp.addItem( { type:TimeManage.TYPE_STILL, last:0.3, state: { alpha:0 }} );
			dp.addItem( { type:TimeManage.TYPE_STILL, last:0.3, state: { alpha:1 }} );
			tm.motion = dp;
			tm.repeat = 3;
			
			gm = new GroupManage("chooseFrameGroup");
